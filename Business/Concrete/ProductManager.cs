...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        {
            if (GetAllByCategoryId(categoryId).Data.Count > 10) return new ErrorResult(Messages.ProductCountOfCategoryError);
        ...
        private IResult CheckIfProductNameExists(string productName)
        {
            ...
            if (result.Count > 0) return new ErrorResult(Messages.ProductNameAlreadyExists);
            return new SuccessResult();
